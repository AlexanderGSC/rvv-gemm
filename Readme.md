...
| :---: | :---: | :---: | :---: | :---: | :--- |
| **32 x 32** | 0.712 s | 588,147,925 | 2,267,033 | 0.39% | **Underutilised:** The block is small; increases the overhead of the outer loops (588M loads). |
| **50 x 50** | **0.310 s** | 368,267,051 | 2,762,719 | 0.75% | **Optimal net balance:** Maximum execution speed and reduced control instructions. |
| **64 x 64** | **0.320 s** | 361,152,490 | 2,463,928 | 0.68% | **Alignment optimum:** Perfect alignment with 64-byte cache lines and RVV bursts. |
| **128 x 128** | 0.452 s | 359,436,762 | 8,375,178 | **2.33%** | **Saturation and Overflow:** Massive eviction of cache lines (eviction to L2). |
